...
async function updateSummaryTab() {
  ...
  const values = [
    ...
    ["Time Format", '=INT(B18)&":"&TEXT(MOD(B18,1)*60,"00")', "h:mm"],
    ["Next Hour At", `=CEILING(B9/30,1)*30`, "hrs worked"],
    ["Hours Until Next", `=B20-B9`, "hrs"],
    [""],
    ["🎯 RAISE PROGRESS"],
    ["Current Rate", `$${HOURLY_RATE}/hr`],
    ["Next Milestone", `=CEILING(B9/1000,1)*1000`, "hrs"],
    ["Hours to Go", `=B25-B9`, "hrs"],
    ["Progress %", `=B9/B25`, "%"],
    [""],
    ["📊 AVERAGES"],
    ["Avg Hours/Week", "=IF(B15>0,B9/B15,0)", "hrs/wk"],
    ["Avg Pay/Week", "=IF(B15>0,B14/B15,0)", "$/wk"],
    ["Sunday Premium", "=B13", "$"],
    [""],
    ["📅 MONTHLY SUMMARY"],
