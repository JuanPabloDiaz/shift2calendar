...
async function updateSummaryTab() {
  ...
  const values = [
    ...
    ["Pay This Period", `=SUM(FILTER(Schedule!F:F,Schedule!H:H=B4))`, "$"],
    [""],
    [`📈 YEAR-TO-DATE TOTALS`],
    ...
    ["Time Format", '=TEXT(B19/24,"[h]:mm")', "h:mm"],
    ["Next Hour At", `=CEILING(B9/30)*30`, "hrs worked"],
    ["Hours Until Next", `=B21-B9`, "hrs"],
    [""],
    ["🎯 RAISE PROGRESS"],
    ["Current Rate", `$${HOURLY_RATE}/hr`],
    ["Next Milestone", `=CEILING(B9/1000)*1000`, "hrs"],
    ["Hours to Go", `=B26-B9`, "hrs"],
    ["Progress %", `=B9/B26`, "%"],
    [""],
    ["📊 AVERAGES"],
    ["Avg Hours/Week", "=IF(B16>0,B9/B16,0)", "hrs/wk"],
    ["Avg Pay/Week", "=IF(B16>0,B15/B16,0)", "$/wk"],
    ["Sunday Premium", "=B14", "$"],
    [""],
    ["📅 MONTHLY SUMMARY"],
