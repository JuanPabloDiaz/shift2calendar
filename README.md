...
- Usar este código libremente para cualquier propósito (personal o comercial)
- Modificar y adaptar el código a tus necesidades
- Distribuir copias del código original o modificado
- Incluir este código en tus propios proyectos

⚠️ **Con la condición de**:

- Incluir el aviso de copyright y la licencia MIT en cualquier copia
...
Para información detallada sobre el uso de esta aplicación, consulta nuestra página de [Términos y Condiciones](terms.html).

**Puntos importantes**:

- ⚠️ **No afiliado con ningún empleador** - Proyecto personal e independiente
- 🔒 **Sin recolección de datos** - Todo funciona en tu navegador
- 🚫 **No es spam** - No envía correos ni notificaciones no solicitadas
- 💰 **Gratuito y sin anuncios** - No busca generar ganancias
- 📂 **Open Source** - Código transparente y auditable

### Privacidad

Esta aplicación:

- **No tiene servidor backend** - Todo el procesamiento ocurre en tu navegador
- **No almacena datos personales** - Sin bases de datos ni servidores
- **Integración con Google** (opcional) - Solo guarda datos en TU cuenta de Google, bajo tu control
...
_Esta herramienta es un proyecto personal creado para facilitar la gestión de horarios laborales. Si te es útil, ¡genial! Si encuentras algún problema o tienes sugerencias, siéntete libre de abrir un issue o contribuir al proyecto._
